<template>
  ...
  <div id="fishBowl" class="container">
    <div class="row">
      <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2" v-for="(result, i) in fishes" :key="i" @click="goToFishDetails(result['Path'])">
        <div class="card">
          <img class="img-thumbnail" :src="result['Species Illustration Photo'].src" :alt="result['Species Illustration Photo'].alt">
